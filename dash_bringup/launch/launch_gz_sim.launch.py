...
def generate_launch_description():
    ...
    default_world = 'empty.sdf' #'industrial-warehouse' 'empty_room' 'tugbot_warehouse'

    world_arg = DeclareLaunchArgument(
        'world',
        default_value=default_world,
        description='World to load: tugbot_warehouse.sdf, industrial-warehouse.sdf, empty.sdf'
        )
