...
def generate_launch_description():
    ...
    dash_nav2_dir = get_package_share_directory('dash_nav2')
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(dash_nav2_dir, 'config', 'nav2_bringup_params.yaml'),
    ...
    declare_mapper_online_async_param_cmd = DeclareLaunchArgument(
        'async_param',
        default_value=os.path.join(dash_nav2_dir, 'config', 'mapper_params_online_async.yaml'),
    ...
    declare_rviz_config_file_cmd = DeclareLaunchArgument(
        'rviz_config',
        default_value=os.path.join(dash_nav2_dir, 'rviz', 'nav2_mapping_view.rviz'),
    ...
    robot_localization_node = Node(
       ...
       output='screen',
       parameters=[os.path.join(dash_nav2_dir, 'config/ekf.yaml'), {'use_sim_time': use_sim_time}]
    )
